...
const likeLastPictureUser = async (browser, page, crypted, userWhoLikedPicture, pictureToScrap) => {
    ...
    if (await page.$('._9AhH0')) {
        ...
        if (await catchErr(browser, crypted, page.waitForSelector('.fr66n .dCJp8.afkep')))
            return

        if (await page.$('.fr66n .dCJp8.afkep .glyphsSpriteHeart__outline__24__grey_9')) {
            await page.waitFor(500)
            await page.click('.fr66n .dCJp8.afkep')
